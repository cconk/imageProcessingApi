...
describe('utilities tests', function () {
    ...
    it('should complete processing a file and return a message', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should return false', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectAsync(utilities_1.default.checkForThumbFile()).toBeResolvedTo(false)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
